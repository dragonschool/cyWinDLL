...
If Not m_blnInitiated Then
    ...
    Else
        ...
        Err.Raise lngResult, "modWinsock.InitiateProcesses", GetErrorDescription(lngResult)
...
If m_blnInitiated And m_lngSocksQuantity = 0 Then
    If FinalizeService = SOCKET_ERROR Then
        ...
        Err.Raise lngErrorCode, "modWinsock.FinalizeProcesses", GetErrorDescription(lngErrorCode)
    Else
...
If lngResult = 0 Then
    ...
    Err.Raise sckOutOfMemory, "modWinsock.DestroyWinsockMessageWindow", "Out of memory"
Else
...
If m_colSocketsInst Is Nothing Then
    ...
    If CreateWinsockMessageWindow <> 0 Then
        Err.Raise sckOutOfMemory, "modWinsock.RegisterSocket", "Out of memory"
    End If
...
If blnEvents Then
    ...
    If lngResult = SOCKET_ERROR Then
        ...
        lngErrorCode = Err.LastDllError
        Err.Raise lngErrorCode, "modWinsock.RegisterSocket", GetErrorDescription(lngErrorCode)
    Else
